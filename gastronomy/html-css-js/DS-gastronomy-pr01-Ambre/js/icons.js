 ...
 *
 * Provenance: every `viewBox` / `path` pair below is Font Awesome Free 7.3.1
 * (https://fontawesome.com) artwork, icon assets licensed under CC BY 4.0
 * (https://creativecommons.org/licenses/by/4.0/). Keep the geometry verbatim so
 * this single attribution stays accurate for the whole registry.
 */
...
const ICONS = {
  ...
  "chevron-down": {
    viewBox: "0 0 640 640",
    path: "M297.4 470.6C309.9 483.1 330.2 483.1 342.7 470.6L534.7 278.6C547.2 266.1 547.2 245.8 534.7 233.3C522.2 220.8 501.9 220.8 489.4 233.3L320 402.7L150.6 233.4C138.1 220.9 117.8 220.9 105.3 233.4C92.8 245.9 92.8 266.2 105.3 278.7L297.3 470.7z",
  },
  clock: {
    viewBox: "0 0 640 640",
    path: "M320 64C461.4 64 576 178.6 576 320C576 461.4 461.4 576 320 576C178.6 576 64 461.4 64 320C64 178.6 178.6 64 320 64zM296 184L296 320C296 328 300 335.5 306.7 340L402.7 404C413.7 411.4 428.6 408.4 436 397.3C443.4 386.2 440.4 371.4 429.3 364L344 307.2L344 184C344 170.7 333.3 160 320 160C306.7 160 296 170.7 296 184z",
  },
  envelope: {
    viewBox: "0 0 640 640",
